...
<body>
    ...
    <section id="about">
        <div class="section-content">
            <h2>About Me</h2>
            <p>I'm naan muthalvan student, its very helpful for me l'm dedicated to staying up to date with the latest trends innovations in the naan muthalvan classes..</p>
        </div>
    </section>
